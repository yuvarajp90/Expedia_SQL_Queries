...
--SELECT distinct cd.locale, cd.campaign_id, cd.campaign_type, cd.campaign_segment_type_id,
--td.slot_position,td.template_id, td.placement_type, td.segment_module_map_id, sm.segment_type_id, sd.segment_criteria, td.module_priority_in_slot, 
--md.module_type_id, md.version, md.module_id, md.[status], md."default"

select distinct md.module_id
	...
	--order by cd.locale, cd.campaign_id, td.slot_position, td.placement_type, td.module_priority_in_slot, md.version, md.module_id
