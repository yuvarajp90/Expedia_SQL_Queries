...
td.slot_position,td.template_id, td.placement_type, td.segment_module_map_id, sm.segment_type_id, td.module_priority_in_slot, 
md.module_type_id, md.version, md.module_id, md."default", mvd.var_position, mvd.var_name, mvd.var_type, mvd.var_source, mvd.var_structure
	...
	where 
		cd.locale in ('en_gb','en_au','en_nz')
		--cd.locale in( 'en_au')
		AND 
